...
.. warning::
   A test database is only intended for testing and remains completed unrelated to your present or
...
Follow the instructions available per hosting type on the `website form <https://upgrade.odoo.com>`_.
make , and select
*Testing* purpose.
